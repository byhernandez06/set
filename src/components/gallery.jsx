...
import img_15 from "../assets/img/company5.jpeg"
            ...
            <div className="container">
                <div className="gallery-table" >
                    <div className="section-title">
                        <div className="width">
                            <div className="sub-t">Soluciones Tecnológicas</div>
                            <h2>Impulsa tu negocio con soluciones web innovadoras</h2>
                        </div>
                        <GalleryFilter
                    ...
                    <div className="gallery-btn">
                        <Link className="main-btn" to="/portfolio"><span></span><i className="ri-function-line"></i> Ver todas las imágenes</Link>
                    </div>
                </div>
            </div>
        </motion.div>
